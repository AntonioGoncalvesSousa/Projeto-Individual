...
function pontosBanco(req, res) {
    ...
    if (qtdPontos == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.pontosBanco(qtdPontos, idUsuario)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function graficoFilme(req, res){
    console.log('Cheguei no controller')
    usuarioModel.graficoFilme().then(
        function (resultado) {
            res.json(resultado);
        }
    ).catch(
